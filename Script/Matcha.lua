...
if not getgenv().ReignMatchaLoaded then 
...
CreateNotification("Loading Reign Matcha", 7)
makefolder("Example")

local Window = libary:new({
    name =  "ReignMatcha.Tea",
    accent = Color3.fromRGB	(68, 98, 74),
    textsize = 13
})
...
local Macro = Misc:section({name = "Autoreload", side = "Right",size = 30})
...
Silentaim:toggle({
    name     = "Enabled",
    def      = getgenv().ReignMatcha.BulletRedirection.Enabled,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Enabled = v
    end
})
Silentaim:toggle({
    name     = "Enable Bullet Redirection",
    def      = getgenv().ReignMatcha.BulletRedirection.Enabled2,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Enabled2 = v
    end
})
Silentaim:toggle({
    name     = "Enable Sticky Target",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.StickyAim,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.StickyAim = v
    end
})
Silentaim:keybind({
    name = "Sticky Key",
    flag = "SilentKey",
    mode = "Toggle",
    value = getgenv().ReignMatcha.BulletRedirection.Settings.StickyAimKeybind,
    callback = function(val)
        getgenv().ReignMatcha.BulletRedirection.Settings.StickyAimKeybind = val
    end
})
...
Silentaim:slider({
    name     = "Hit Chance (%)",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.SilentHitChance,
    max      = 100,
    min      = 1,
    rounding = true,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.SilentHitChance = v
    end
})

Silentaim:toggle({
    name     = "Use Closest Part",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.UseClosestPart,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.UseClosestPart = v
    end
})
Silentaim:toggle({
    name     = "Use Closest Point",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.UseClosestPoint,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.UseClosestPoint = v
    end
})
PlayerMisc:slider({
...
Silentaim:toggle({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Settings.AutoPrediction.Enabled,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.AutoPrediction.Enabled = v
    end
})
Silentaim:dropdown({
    name     = "Hit Part",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.TargetHitPart,
    max      = 4,
    options  = {"Head", "UpperTorso", "LowerTorso", "HumanoidRootPart"},
    callback = function(part)
        getgenv().ReignMatcha.BulletRedirection.Settings.TargetHitPart = part
    end
})
...
RunService.Heartbeat:Connect(function()
    local target = ReignMatcha.BulletRedirection.Internal.LockedTarget
    ...
    local in_range = distance <= ReignMatcha.BulletRedirection.Settings.MagicBulletRange
...
Silentaim:toggle({
    name     = "Safe Mode",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.SafeMode,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.SafeMode = v
    end
})

MagicBulletTab:toggle({
    name     = "Magic Bullet",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.MagicBullet,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.MagicBullet = v
    end
})
MagicBulletTab:toggle({
...
MagicBulletTab:slider({
    ...
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.MagicBulletRange,
    max      = 300,
    min      = 0,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.MagicBulletRange = v
    end
})

Silentaim:toggle({
    name     = "Dynamic Prediction",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.DynamicPrediction,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.DynamicPrediction = v
    end
})

Silentaim:slider({
    name     = "Prediction Value",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.PredictionForSilent,
    max      = 1,
    min      = 0,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.PredictionForSilent = v
    end
})

CheksForbullets:toggle({
    name     = "Anti-Aim Viewer",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.AntiAimViewer,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.AntiAimViewer = v
    end
})
CheksForbullets:toggle({
    name     = "In Fov",
    def      = ReignMatcha.BulletRedirection.Settings.UseFovCheck,
    callback = function(v)
        ReignMatcha.BulletRedirection.Settings.UseFovCheck = v
    end
})
CheksForbullets:toggle({
    name     = "Anti-Curve",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.AntiCurve,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.AntiCurve = v
    end
})

Silentaim:toggle({
    name     = "Auto-Enable Resolver",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.AutoEnableResolver,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.AutoEnableResolver = v
    end
})

Silentaim:dropdown({
    name     = "Resolver Mode",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.Resolver,
    max      = 3,
    options  = {"None", "Velocity", "Recalculation"},
    callback = function(opt)
        getgenv().ReignMatcha.BulletRedirection.Settings.Resolver = opt
    end
})

CheksForbullets:toggle({
    name     = "Wall Check",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.IgnoreInvisibleTargets,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.IgnoreInvisibleTargets = v
    end
})

CheksForbullets:toggle({
    name     = "Dead Check",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.IgnoreDeadTargets,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.IgnoreDeadTargets = v
    end
})
CheksForbullets:toggle({
    name     = "Distance Check",
    def      = ReignMatcha.BulletRedirection.Settings.DistanceCheck,
    callback = function(v)
        ReignMatcha.BulletRedirection.Settings.DistanceCheck = v
    end
})
CheksForbullets:slider({
    name     = "Distance Check Max Range",
    def      = ReignMatcha.BulletRedirection.Settings.DistanceCheckDistance,
    max      = 5000,
    min      = 1,
    rounding = false,
    callback = function(v)
        ReignMatcha.BulletRedirection.Settings.DistanceCheckDistance = v
    end
})
CheksForbullets:toggle({
    name     = "Tool Check",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.IgnoreNoToolTargets,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.IgnoreNoToolTargets = v
    end
})

Silentaim:slider({
    name     = "Ping Compensation",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.PingSpoofCompensation,
    max      = 1,
    min      = 0,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.PingSpoofCompensation = v
    end
})

Silentaim:toggle({
    name     = "Staggered Prediction",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.StaggeredPredictionMode,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.StaggeredPredictionMode = v
    end
})

Silentaim:slider({
    name     = "Internal Cooldown",
    def      = getgenv().ReignMatcha.BulletRedirection.Settings.InternalCooldown,
    max      = 5,
    min      = 0,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Settings.InternalCooldown = v
    end
})

for partName, defaultVal in pairs(getgenv().ReignMatcha.BulletRedirection.Settings.StaggeredPredictionValues) do
    Silentaim:slider({
        ...
        rounding = false,
        callback = function(v)
            getgenv().ReignMatcha.BulletRedirection.Settings.StaggeredPredictionValues[partName] = v
        end
    })
end
...
LocalVisuals:dropdown({
    ...
    def = auratype,
    max = 4,
    options = {"Green Aura", "Godly", "Super Sayien", "North Star", "Blue Lord", "North Star V2", "WalkStep", "Pink Aura"},
    callback = function(part)
        auratype = part

        if auratype == "Green Aura" then
...
Playersection:textbox({
    ...
    def      = table.concat(getgenv().ReignMatcha.BulletRedirection.Settings.PlayerWhitelist, ","),
    callback = function(txt)
        local t = {}
        for id in txt:gmatch("[^,]+") do t[#t+1] = id end
        getgenv().ReignMatcha.BulletRedirection.Settings.PlayerWhitelist = t
    end
})

Playersection:textbox({
    name     = "Player Blacklist",
    def      = table.concat(getgenv().ReignMatcha.BulletRedirection.Settings.PlayerBlacklist, ","),
    callback = function(txt)
        local t = {}
        for id in txt:gmatch("[^,]+") do t[#t+1] = id end
        getgenv().ReignMatcha.BulletRedirection.Settings.PlayerBlacklist = t
    end
})

Silentvisuals:slider({
    name     = "FOV Radius",
    def      = getgenv().ReignMatcha.BulletRedirection.Visualization.FOV,
    max      = 500,
    min      = 0,
    rounding = true,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.FOV = v
    end
})

Silentaim:toggle({
    name     = "Show FOV",
    def      = getgenv().ReignMatcha.BulletRedirection.Visualization.ShowFOV,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.ShowFOV = v
    end
})

Silentaim:colorpicker({
    name     = "FOV Color",
    def      = getgenv().ReignMatcha.BulletRedirection.Visualization.FOVColor,
    callback = function(c)
        getgenv().ReignMatcha.BulletRedirection.Visualization.FOVColor = c
    end
})

Silentaim:slider({
    name     = "FOV Thickness",
    def      = getgenv().ReignMatcha.BulletRedirection.Visualization.FOVThickness,
    max      = 10,
    min      = 0.1,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.FOVThickness = v
    end
})

Silentvisuals:toggle({
    name = "Enable Tracer",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.Tracer,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.Tracer = v
    end
})

Silentvisuals:dropdown({
    name = "Tracer Mode",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.TracerMode,
    options = {"Center", "Mouse"},
    callback = function(mode)
        getgenv().ReignMatcha.BulletRedirection.Visualization.TracerMode = mode
    end
})

Silentvisuals:toggle({
    name = "Enable Highlight",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.Highlight,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.Highlight = v
    end
})

Silentvisuals:toggle({
    name = "Enable Distance Text",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.DistanceText,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.DistanceText = v
    end
})

Silentvisuals:toggle({
    name = "Enable 3D Target Line",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.TargetLine,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.TargetLine = v
    end
})
...
Silentaim:toggle({
    ...
    def      = getgenv().ReignMatcha.BulletRedirection.Internal.UnlockOnDeath,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Internal.UnlockOnDeath = v
    end
})

Silentaim:toggle({
    name     = "Use Camlock Target",
    def      = getgenv().ReignMatcha.BulletRedirection.Internal.UseCamlockTarget,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Internal.UseCamlockTarget = v
    end
})

Camlock:toggle({
    name     = "Enabled",
    def      = getgenv().ReignMatcha.Aimbot.Enabled,
    callback = function(v)
        getgenv().ReignMatcha.Aimbot.Enabled = v
    end
})
print("check3")
Camlock:slider({
    name     = "Smoothness",
    def      = getgenv().ReignMatcha.Aimbot.Smoothness,
    max      = 1,
    min      = 0,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.Aimbot.Smoothness = v
    end
})
local networking = {
    last_slept = os.clock(),
...
Mt.__index = function(Self, Index)
    if not checkcaller() and Self == Mouse then
        if (Index == "Hit" or (Index == "Target" and game.PlaceId == 122868680533440)) and Config.BulletTp then
            local Target = Script.Targeting.Target
            if Target and Target.Character then
                local Part = Target.Character:FindFirstChild(Config.Part)
...
run_service.RenderStepped:Connect(function()
    local locked_target = ReignMatcha.BulletRedirection.Internal.LockedTarget
    ...
    if voidSpamCounter == 0 then
        ...
        desync.teleportPosition = Vector3.new(
            ...
            elseif desync.mode == "Orbit" then
                if not ReignMatcha.BulletRedirection.Internal.LockedTarget then return end
                local targetHRP = ReignMatcha.BulletRedirection.Internal.LockedTarget.Character:FindFirstChild("HumanoidRootPart")
                 if ViewOrbittedTarget then
                    Workspace.CurrentCamera.CameraSubject = ReignMatcha.BulletRedirection.Internal.LockedTarget.Character:FindFirstChildOfClass("Humanoid")
                 end
                local time = tick()
...
Camlock:slider({
    name     = "Prediction",
    def      = getgenv().ReignMatcha.Aimbot.Prediction,
    max      = 1,
    min      = 0,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.Aimbot.Prediction = v
    end
})

Camlock:dropdown({
    name     = "Aim Part",
    def      = getgenv().ReignMatcha.Aimbot.AimPart,
    max      = 4,
    options  = {"Head", "UpperTorso", "LowerTorso", "HumanoidRootPart"},
    callback = function(opt)
        getgenv().ReignMatcha.Aimbot.AimPart = opt
    end
})

Camlock:slider({
    name     = "FOV",
    def      = getgenv().ReignMatcha.Aimbot.FOV,
    max      = 500,
    min      = 0,
    rounding = true,
    callback = function(v)
        getgenv().ReignMatcha.Aimbot.FOV = v
    end
})

Camlock:toggle({
    name     = "Show FOV",
    def      = getgenv().ReignMatcha.Aimbot.ShowFOV,
    callback = function(v)
        getgenv().ReignMatcha.Aimbot.ShowFOV = v
    end
})
...
Camlock:keybind({
    ...
    flag = "Camlock_key",
    mode = "Toggle",
    value = getgenv().ReignMatcha.Aimbot.LockOnKey,
    callback = function(val)
        getgenv().ReignMatcha.Aimbot.LockOnKey = val
    end
})

Camlock:toggle({
    name     = "Hold Bind",
    def      = getgenv().ReignMatcha.Aimbot.HoldBind,
    callback = function(v)
        getgenv().ReignMatcha.Aimbot.HoldBind = v
    end
})

Camlock:toggle({
    name     = "Unlock On Death",
    def      = getgenv().ReignMatcha.Aimbot.UnlockOnDeath,
    callback = function(v)
        getgenv().ReignMatcha.Aimbot.UnlockOnDeath = v
    end
})

Camlock:slider({
    name     = "Y-Axis Offset",
    def      = getgenv().ReignMatcha.Aimbot.Yaxis,
    max      = 100,
    min      = -100,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.Aimbot.Yaxis = v
    end
})

Camlock:dropdown({
    name     = "Mode",
    def      = getgenv().ReignMatcha.Aimbot.Type,
    max      = 2,
    options  = {"Camera","Mouse"},
    callback = function(opt)
        getgenv().ReignMatcha.Aimbot.Type = opt
    end
})
...
WorldVisuals2:toggle({
    name = "Enable Fog",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogEnabled,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogEnabled = v
        if v then
            game.Lighting.FogEnd = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogEnd
            game.Lighting.FogStart = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogStart
            game.Lighting.FogColor = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogColor
        else
...
WorldVisuals2:slider({
    name = "Fog Start",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogStart,
    min = 0,
    max = 1000,
    rounding = true,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogStart = v
        if getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogEnabled then
...
WorldVisuals2:slider({
    name = "Fog End",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogEnd,
    min = 0,
    max = 1000,
    rounding = true,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogEnd = v
        if getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogEnabled then
...
WorldVisuals2:colorpicker({
    name = "Fog Color",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogColor,
    callback = function(c)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogColor = c
        if getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogEnabled then
...
WorldVisuals2:toggle({
    name = "Enable Ambient",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.AmbientEnabled,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.AmbientEnabled = v
        if v then
            game.Lighting.Ambient = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.AmbientColor
        else
...
WorldVisuals2:toggle({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.TimeControlEnabled,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.TimeControlEnabled = v
        if v then
            game.Lighting.ClockTime = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ClockTime
        end
    end
})
...
WorldVisuals2:slider({
    name = "Clock Time",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ClockTime,
    min = 0,
    max = 24,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ClockTime = v
        if getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.TimeControlEnabled then
...
WorldVisuals2:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ShadowSoftness,
    min = 0,
    max = 1,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ShadowSoftness = v
...
WorldVisuals2:colorpicker({
    name = "ColorShift Top",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorShiftTop,
    callback = function(c)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorShiftTop = c
...
WorldVisuals2:colorpicker({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorShiftBottom,
    callback = function(c)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorShiftBottom = c
...
WorldVisuals2:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.EnvironmentDiffuseScale,
    min = 0,
    max = 1,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.EnvironmentDiffuseScale = v
...
WorldVisuals2:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.EnvironmentSpecularScale,
    min = 0,
    max = 1,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.EnvironmentSpecularScale = v
...
WorldVisuals2:colorpicker({
    name = "Ambient Color",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.AmbientColor,
    callback = function(c)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.AmbientColor = c
        if getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.AmbientEnabled then
...
WorldVisuals2:toggle({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.OutdoorAmbientEnabled,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.OutdoorAmbientEnabled = v
        if v then
            game.Lighting.OutdoorAmbient = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.OutdoorAmbientColor
        else
...
WorldVisuals2:colorpicker({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.OutdoorAmbientColor,
    callback = function(c)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.OutdoorAmbientColor = c
        if getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.OutdoorAmbientEnabled then
...
WorldVisuals3:slider({
    name = "Brightness",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.Brightness,
    min = 0,
    max = 10,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.Brightness = v
...
WorldVisuals3:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ExposureCompensation,
    min = -5,
    max = 5,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ExposureCompensation = v
        game.Lighting.ExposureCompensation = v
    end
})
WorldVisuals3:toggle({
    name = "Enable Sun Rays",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.SunRaysEnabled,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.SunRaysEnabled = v
        local sunRays = game.Lighting:FindFirstChildOfClass("SunRaysEffect")
        if not sunRays then
            sunRays = Instance.new("SunRaysEffect", game.Lighting)
        end
        sunRays.Enabled = v
        sunRays.Intensity = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.SunRaysIntensity
        sunRays.Spread = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.SunRaysSpread
    end
})

WorldVisuals3:slider({
    name = "Sun Rays Intensity",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.SunRaysIntensity,
    min = 0,
    max = 1,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.SunRaysIntensity = v
        local sunRays = game.Lighting:FindFirstChildOfClass("SunRaysEffect")
        if sunRays then
            sunRays.Intensity = v
        end
 ...
 CameraSettings = getgenv().ReignMatcha.BulletRedirection.Visualization.CameraEditor or {}
getgenv().ReignMatcha.BulletRedirection.Visualization.CameraEditor = CameraSettings
...
WorldVisuals3:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.SunRaysSpread,
    min = 0,
    max = 1,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.SunRaysSpread = v
        local sunRays = game.Lighting:FindFirstChildOfClass("SunRaysEffect")
        if sunRays then
            sunRays.Spread = v
        end
...
WorldVisuals4:dropdown({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.LightingTechnology,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.LightingTechnology = v
        game.Lighting.Technology = Enum.Technology[v]
    end
})
WorldVisuals4:toggle({
    name = "Enable Global Shadows",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.GlobalShadows,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.GlobalShadows = v
...
WorldVisuals4:dropdown({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.FogStyle,
    callback = function(style)
        local settings = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals
...
WorldVisuals5:toggle({
    name = "Enable Blur",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BlurEnabled,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BlurEnabled = v
        local blur = game.Lighting:FindFirstChildOfClass("BlurEffect") or Instance.new("BlurEffect", game.Lighting)
        blur.Enabled = v
        blur.Size = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BlurSize
    end
})

WorldVisuals5:slider({
    name = "Blur Size",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BlurSize,
    min = 0,
    max = 100,
    rounding = true,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BlurSize = v
...
WorldVisuals2:toggle({
    name = "Enable Bloom",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BloomEnabled,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BloomEnabled = v
        local bloom = game.Lighting:FindFirstChildOfClass("BloomEffect") or Instance.new("BloomEffect", game.Lighting)
        bloom.Enabled = v
        bloom.Intensity = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BloomIntensity
        bloom.Threshold = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BloomThreshold
        bloom.Size = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BloomSize
    end
})

WorldVisuals2:slider({
    name = "Bloom Intensity",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BloomIntensity,
    min = 0,
    max = 10,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BloomIntensity = v
...
WorldVisuals2:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BloomThreshold,
    min = 0,
    max = 5,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BloomThreshold = v
        local bloom = game.Lighting:FindFirstChildOfClass("BloomEffect")
        if bloom then
            bloom.Threshold = v
        end
...
WorldVisuals2:slider({
    name = "Bloom Size",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BloomSize,
    min = 0,
    max = 100,
    rounding = true,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.BloomSize = v
        local bloom = game.Lighting:FindFirstChildOfClass("BloomEffect")
        if bloom then
            bloom.Size = v
        end
...
WorldVisuals2:toggle({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionEnabled,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionEnabled = v
        local cc = game.Lighting:FindFirstChildOfClass("ColorCorrectionEffect") or Instance.new("ColorCorrectionEffect", game.Lighting)
        cc.Enabled = v
        cc.Brightness = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionBrightness
        cc.Contrast = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionContrast
        cc.Saturation = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionSaturation
...
WorldVisuals2:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionBrightness,
    min = -1,
    max = 1,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionBrightness = v
...
WorldVisuals2:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionContrast,
    min = -1,
    max = 1,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionContrast = v
        local cc = game.Lighting:FindFirstChildOfClass("ColorCorrectionEffect")
        if cc then
            cc.Contrast = v
        end
...
WorldVisuals2:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionSaturation,
    min = -1,
    max = 1,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionSaturation = v
        local cc = game.Lighting:FindFirstChildOfClass("ColorCorrectionEffect")
        if cc then
            cc.Saturation = v
        end
...
WorldVisuals2:colorpicker({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionTintColor,
    callback = function(c)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.ColorCorrectionTintColor = c
        local cc = game.Lighting:FindFirstChildOfClass("ColorCorrectionEffect")
        if cc then
            cc.TintColor = c
        end
...
WorldVisuals5:toggle({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldEnabled,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldEnabled = v
        local dof = game.Lighting:FindFirstChildOfClass("DepthOfFieldEffect") or Instance.new("DepthOfFieldEffect", game.Lighting)
        dof.Enabled = v
        dof.FarIntensity = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldFarIntensity
        dof.FocusDistance = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldFocusDistance
        dof.InFocusRadius = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldInFocusRadius
        dof.NearIntensity = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldNearIntensity
    end
})

WorldVisuals5:slider({
    name = "DOF Far Intensity",
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldFarIntensity,
    min = 0,
    max = 1,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldFarIntensity = v
...
WorldVisuals5:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldFocusDistance,
    min = 0,
    max = 1000,
    rounding = true,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldFocusDistance = v
        local dof = game.Lighting:FindFirstChildOfClass("DepthOfFieldEffect")
        if dof then
            dof.FocusDistance = v
        end
...
WorldVisuals5:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldInFocusRadius,
    min = 0,
    max = 100,
    rounding = true,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldInFocusRadius = v
        local dof = game.Lighting:FindFirstChildOfClass("DepthOfFieldEffect")
        if dof then
            dof.InFocusRadius = v
        end
...
WorldVisuals5:slider({
    ...
    def = getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldNearIntensity,
    min = 0,
    max = 1,
    rounding = false,
    callback = function(v)
        getgenv().ReignMatcha.BulletRedirection.Visualization.WorldVisuals.DepthOfFieldNearIntensity = v
        local dof = game.Lighting:FindFirstChildOfClass("DepthOfFieldEffect")
        if dof then
            dof.NearIntensity = v
        end
...
GunMods:toggle({
    name     = "No Recoil",
    def      = getgenv().ReignMatcha.Recoil.Enabled,
    callback = function(v)
        getgenv().ReignMatcha.Recoil.Enabled = v
    end
})

MovmentMisc:toggle({
    name     = "Anti-Fling",
    def      = getgenv().ReignMatcha.AntiFling.Enabled,
    callback = function(v)
        getgenv().ReignMatcha.AntiFling.Enabled = v
    end
})

MovmentMisc:toggle({
    name     = "Prevent Sit",
    def      = getgenv().ReignMatcha.AntiSit.Enabled,
    callback = function(v)
        getgenv().ReignMatcha.AntiSit.Enabled = v
    end
})


-- Khai báo biến global cần thiết (giả sử bạn đã có Orion hoặc library tương tự)
local Shop = {}  -- Table cho multidropdown, sẽ fill tự động từ ShopTable

local ShopTable = {}

local headshots = {}
headshots.AutoLoadout = {Enabled = false, Guns = {}, ArmorEnabled = false, Queue = {}, CurrentBuying = nil}

-- Build ShopTable và fill options cho multidropdown
local function BuildShopTable()
    ...
    for _, shop in pairs(shopFolder:GetChildren()) do
        if shop:FindFirstChild("Head") then
            ...
            if key then
                ...
                -- Chỉ add gun (không ammo, không armor) vào multidropdown
                if key:match("%[.-%]") and not key:match("Ammo") and not key:match("Armor") then
                    table.insert(Shop, key)
                end
            else
    ...
    table.sort(Shop)  -- Sort alphabet cho multidropdown đẹp
end

-- Build lần đầu
BuildShopTable()

-- Rebuild định kỳ (an toàn nếu game update shop trong session)
spawn(function()
    while wait(30) do
        BuildShopTable()
        -- Nếu library hỗ trợ refresh dropdown, có thể call ở đây
    end
end)

-- Hàm check inventory ammo (giả sử cấu trúc DataFolder như bạn có)
local function GetInventoryAmmo(gunName)
    local inv = game.Players.LocalPlayer:FindFirstChild("DataFolder") and game.Players.LocalPlayer.DataFolder:FindFirstChild("Inventory")
    if not inv then return 0 end
    local ammo = inv:FindFirstChild(gunName)
    return ammo and tonumber(ammo.Value) or 0
end

-- Hàm check có Armor (thường là BodyEffects.Armor hoặc similar, chỉnh nếu khác)
...
Playersection:toggle({
    ...
    def = false,
    callback = function(v)
        headshots.AutoLoadout.Enabled = v
    end
})

Playersection:multidropdown({
    name = "Select Guns (Multi)",
    options = Shop,  -- Đã fill tự động
    callback = function(v)  -- v là table các giá trị được chọn
        headshots.AutoLoadout.Guns = {}
        for _, gunKey in pairs(v) do
            headshots.AutoLoadout.Guns[gunKey] = true
        end
    end
})
...
Playersection:toggle({
    ...
    def = false,
    callback = function(v)
        headshots.AutoLoadout.ArmorEnabled = v
    end
})
...
RunService.Heartbeat:Connect(function()
    ...
    pcall(function()
        if headshots.AutoLoadout.Enabled then
            -- Build queue nếu chưa có item đang mua và queue rỗng
            if not headshots.AutoLoadout.CurrentBuying and #headshots.AutoLoadout.Queue == 0 then
                local orderedGuns = {}
                ...
                for _, gun in ipairs(orderedGuns) do
                    local hasGun = char:FindFirstChild(gun) or game.Players.LocalPlayer.Backpack:FindFirstChild(gun)
                    if not hasGun then
                        if ShopTable[gun] then
                            table.insert(headshots.AutoLoadout.Queue, {type = "gun", name = gun})
                        end
                    else
                        ...
                        if invAmmo == 0 then
                            ...
                            if ShopTable[ammoKey] then
                                table.insert(headshots.AutoLoadout.Queue, {type = "ammo", gun = gun, ammoKey = ammoKey})
                            end
                        end
                    end
                end
                ...
                -- Auto Armor ở cuối
                if headshots.AutoLoadout.ArmorEnabled and not HasArmor() then
                    if ShopTable["[Armor]"] then
                        table.insert(headshots.AutoLoadout.Queue, {type = "armor"})
                    end
                end
            end

            -- Bắt đầu mua item đầu queue
            if #headshots.AutoLoadout.Queue > 0 and not headshots.AutoLoadout.CurrentBuying then
                headshots.AutoLoadout.CurrentBuying = table.remove(headshots.AutoLoadout.Queue, 1)
                BuyingActive = true  -- Nếu bạn dùng để disable strafe tạm thời
            end
        end
        ...
        if headshots.AutoLoadout.CurrentBuying then
            ...
            elseif item.type == "ammo" then
                shopName = ShopTable[item.ammoKey].ShopName
...
function knockTarget(targetPlayer)
 ...
 buttonProps75353 = {
    ...
    callback = function() 
        ...
        knockTarget(ReignMatcha.BulletRedirection.Internal.LockedTarget)
    end
}
...
function manipulate(gun)
    ...
    if getgenv().ReignMatcha.WeaponMods.RapidFire.Enabled then
...
GunMods:toggle({
    ...
    def      = getgenv().ReignMatcha.WeaponMods.RapidFire.Enabled,
    callback = function(v)
        getgenv().ReignMatcha.WeaponMods.RapidFire.Enabled = v
    end
})
GunMods:toggle({
    name     = "Ammo Hack",
...
FOVCircle.Visible = ReignMatcha.BulletRedirection.Enabled and ReignMatcha.BulletRedirection.Visualization.ShowFOV
FOVCircle.Radius = ReignMatcha.BulletRedirection.Visualization.FOV
FOVCircle.Color = ReignMatcha.BulletRedirection.Visualization.FOVColor
FOVCircle.Thickness = ReignMatcha.BulletRedirection.Visualization.FOVThickness
FOVCircle.Transparency = ReignMatcha.BulletRedirection.Visualization.FOVTransparency
FOVCircle.NumSides =  ReignMatcha.BulletRedirection.Visualization.FovSides
FOVCircle.Filled = false

FOVCircle2 = Drawing.new("Circle")
FOVCircle2.Visible = ReignMatcha.Aimbot.Enabled and ReignMatcha.Aimbot.ShowFOV
FOVCircle2.Radius = ReignMatcha.Aimbot.FOV
FOVCircle2.Color = ReignMatcha.BulletRedirection.Visualization.FOVColor
FOVCircle2.Thickness = ReignMatcha.BulletRedirection.Visualization.FOVThickness
FOVCircle2.Transparency = ReignMatcha.BulletRedirection.Visualization.FOVTransparency
...
function CheckAnti(player)
    ...
    if ReignMatcha.BulletRedirection.AutoEnableResolver then
        getgenv().ReignMatcha.BulletRedirection.Settings.Resolver = isAnti and "Recalculation" or "None"
    end
...
RunService.Heartbeat:Connect(function()
    if not ReignMatcha.BulletRedirection.Enabled then return end
    if not ReignMatcha.BulletRedirection.AutoEnableResolver then return end
CheckAnti(ReignMatcha.BulletRedirection.Internal.LockedTarget)
end)

BulletRedirection = ReignMatcha.BulletRedirection
...
Internal.OriginalIndex = hookmetamethod(game, "__index", LPH_NO_VIRTUALIZE(function(object, key, ...)
    ...
    if Settings.UseFovCheck then
        ...
        local fovLimit = getgenv().ReignMatcha.BulletRedirection.Visualization.FOV or 100
 ...
 function findClosestTarget()
    ...
    local hitPart = ReignMatcha.BulletRedirection.Settings.TargetHitPart
...
UserInputService.InputBegan:Connect(function(input, gpe)
    ...
    if input.KeyCode == ReignMatcha.BulletRedirection.Settings.StickyAimKeybind then
        stickyAimToggled = not stickyAimToggled
        stickyTargetLocked = false

        if not stickyAimToggled and ReignMatcha.BulletRedirection.Internal.LockedTarget then
            ReignMatcha.BulletRedirection.Internal.LockedTarget = nil
        end
    end
end)
...
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    if gameProcessed then return end
    if not ReignMatcha.BulletRedirection.Enabled then return end
    if not ReignMatcha.BulletRedirection.Settings.StickyAim then return end
    if ReignMatcha.BulletRedirection.Internal.UseCamlockTarget then return end
    ...
    if input.KeyCode == ReignMatcha.BulletRedirection.Settings.StickyAimKeybind then
        if stickyAimActive then
            ...
            if newTarget then
                ...
                ReignMatcha.BulletRedirection.Internal.LockedTarget = newTarget
            end
        end
    end
end)
...
RunService.Heartbeat:Connect(function()
    local settings = ReignMatcha.BulletRedirection
...
RunService.RenderStepped:Connect(function()
    ...
    if ReignMatcha.BulletRedirection.Enabled
    and target
    ...
    and target.Character:FindFirstChild("HumanoidRootPart") then
        ...
        if ReignMatcha.BulletRedirection.Visualization.Tracer and on_screen then
            tracer.Visible = true
            if ReignMatcha.BulletRedirection.Visualization.TracerMode == "Center" then
                tracer.From = Vector2.new(Camera.ViewportSize.X / 2, Camera.ViewportSize.Y / 2)
            elseif ReignMatcha.BulletRedirection.Visualization.TracerMode == "Mouse" then
        ...
        if ReignMatcha.BulletRedirection.Visualization.TargetLine then
        ...
        if ReignMatcha.BulletRedirection.Visualization.Highlight then
            highlight.Adornee = target.Character
        ...
        if ReignMatcha.BulletRedirection.Visualization.DistanceText and on_screen then
...
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    if gameProcessed then return end
    if input.KeyCode == ReignMatcha.Aimbot.LockOnKey then
        if ReignMatcha.Aimbot.HoldBind then

            ReignMatcha.Aimbot.LockedTarget = findClosestTarget()
            if ReignMatcha.BulletRedirection.Internal.UseCamlockTarget then
                ReignMatcha.BulletRedirection.Internal.LockedTarget = ReignMatcha.Aimbot.LockedTarget
            end
        else
            ...
            if holder then
                ...
                ReignMatcha.Aimbot.LockedTarget = nil
                if ReignMatcha.BulletRedirection.Internal.UseCamlockTarget then
                    ReignMatcha.BulletRedirection.Internal.LockedTarget = nil
                end
            end
...
UserInputService.InputEnded:Connect(function(input)
    if input.KeyCode == ReignMatcha.Aimbot.LockOnKey and ReignMatcha.Aimbot.HoldBind then
        ReignMatcha.Aimbot.LockedTarget = nil
        if ReignMatcha.BulletRedirection.Internal.UseCamlockTarget then
            ReignMatcha.BulletRedirection.Internal.LockedTarget = nil
        end
...
RunService.RenderStepped:Connect(function()
    if not ReignMatcha.Aimbot.Enabled or not ReignMatcha.Aimbot.LockedTarget then return end

    local target = ReignMatcha.Aimbot.LockedTarget
    local aimPartName = ReignMatcha.Aimbot.AimPart
    local prediction = ReignMatcha.Aimbot.Prediction or 0
    local yOffset = ReignMatcha.Aimbot.Yaxis or 0
    local smoothness = ReignMatcha.Aimbot.Smoothness or 1
    local aimbotType = ReignMatcha.Aimbot.Type
 ...
 function AntiFling()
    if not ReignMatcha.AntiFling.Enabled then return end
...
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    if gameProcessed then return end
    if input.KeyCode == ReignMatcha.NoClip.Keybind then
        if ReignMatcha.NoClip.Enabled then
            toggled = not toggled
        end
    end
end)
...
RunService.Stepped:Connect(function()
    if not ReignMatcha.NoClip.Enabled or not toggled then return end
...
RunService.Heartbeat:Connect(function()
    if ReignMatcha and ReignMatcha.BulletRedirection.Settings.Resolver == "Recalculation" then
        pcall(function()
...
LocalPlayer.CharacterAdded:Connect(function(Character)
    if not ReignMatcha.AntiSit.Enabled then return end
            ...
            if Callback then
                ...
                for Index = 1, Info.nups do
                    ...
                    if typeof(Upvalue) == "number" then
                        ...
                        local NewDelay = getgenv().ReignMatcha.WeaponMods.RapidFire.Enabled and 1e-20 or OriginalValues[Index]
...
RunService.Heartbeat:Connect(function()
    ...
    if ReignMatcha.BulletRedirection.Internal.UnlockOnDeath then
        ReignMatcha.BulletRedirection.Internal.LockedTarget = nil
    end

    if ReignMatcha.Aimbot.UnlockOnDeath then
        ReignMatcha.Aimbot.LockedTarget = nil
    end
end)
...
RunService.Heartbeat:Connect(function()
    pcall(function()
        if not ReignMatcha.BulletRedirection.Resolver == "Velocity"  then return end
...
TextLabel_1.Text = "ReignMatcha.CC - Private"
...
getgenv().ReignMatchaLoaded  = true
print("Final Check")
CreateNotification("Loaded ReignMatcha", 7)
